...
public:
	...
	FORCEINLINE bool			GetBool() const	{ if ( g_bAllDisabled ) return false; else  return !!GetInt(); }
...
FORCEINLINE const char *ConVar::GetDefault(void) const
{
